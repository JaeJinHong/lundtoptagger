...
if __name__ == "__main__":
    ...
    config_signal = load_yaml("configs_FourProng/config_signal.yaml")
    signal_string = config_signal["signal"] # Ad-hoc fix
    signal = config_signal[signal_string]
    label_branch = config_signal["jet_label_branch"]
    ...
    for file in files:
        ...
        print ("Good_jets2_count: ", np.sum(Good_jets2))
        ...
        if do_validation:
            ...
            print("tagger_scores_onnx: ", tagger_scores_onnx)
            # ============================================================
            # === Sanity checks
            # ============================================================
            print("PyTorch scores shape:", tagger_scores.shape)
            print("ONNX scores shape:", tagger_scores_onnx.shape)
            ...
            with uproot.recreate(outfile) as f:
                f[treename] = {
                    ...
                    "fjet_AthenaScore_P1":            np.array(AthTool_P1[Good_jet_mask], dtype="float32"),
