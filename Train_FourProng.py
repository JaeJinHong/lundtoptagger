...
def main():
    ...
    mass_window = config['data']['mass_window']
    mass_window_format_dict = {
    ...
    print_memory_usage("Initial RSS usage")
    dataset = []
    ...
    for file_path in path_to_file:
        ...
        print_memory_usage("After loading file {}".format(file_path))
    ...
    for jet_graph in dataset:
        if jet_graph.y == 4: # AdHoc jet labelling
            jet_graph.y = 1.0 # FourProng signal
        elif jet_graph.y == 1:
            jet_graph.y = 0.0 # SingleProng background
    ...
    path_to_save = config['data']['path_to_save'].format(**mass_window_format_dict)
    ...
    model_name = config['data']['model_name'].format(**mass_window_format_dict)
    train_loss = []
    val_loss = []
    train_acc = []
    val_acc = []
